...
The prediction is positive, and the actual situation is also positive.

**False Positive (FP)**

The prediction is positive, but the actual situation is negative.

**True Negative (TN)**

The prediction is negative, and the actual situation is also negative.

**False Negative (FN)**

The prediction is negative, but the actual situation is positive.
